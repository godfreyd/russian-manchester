...
; /* Start:"a:4:{s:4:"full";s:102:"/local/templates/bitlate_pro/components/bitrix/catalog.smart.filter/.default/script.js?150885328723654";s:6:"source";s:86:"/local/templates/bitlate_pro/components/bitrix/catalog.smart.filter/.default/script.js";s:3:"min";s:0:"";s:3:"map";s:0:"";}"*/
		...
		if (!!modef && !!modef_num)
		{
			...
			else
			{
                ...
                if (isHorizontal) {
                    ...
                    if (($parentBlock.index() + 1) % 5) {
                        modef.style.left = $parentBlock.innerWidth() + parentPosition.left + 'px';
                    } else {
                        modef.style.right = $parentBlock.innerWidth() + 'px';
...
/* End */
;; /* /local/templates/bitlate_pro/components/bitrix/catalog.smart.filter/.default/script.js?150885328723654*/
