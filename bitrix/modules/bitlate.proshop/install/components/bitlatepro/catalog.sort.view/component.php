...
$curView = COption::GetOptionString("bitlate.proshop", 'NL_CATALOG_VIEW', false, SITE_ID);
$arResult['VIEW_DEFAULT'] = $curView;
if (CModule::IncludeModule('bitlate.proshop')) {
    $arResult['VIEW_VARIANTS'] = BitlateProUtils::getViewListInfo();
    if ($arParams['REQUEST_VIEW'] != '') {
        if (array_key_exists($arParams['REQUEST_VIEW'], BitlateProUtils::getViewList())) {
