...
$ACTION_POS = COption::GetOptionString("bitlate.proshop", "NL_ACTION_POS_VALUE", false, SITE_ID);
$PRODUCT_SIZE_TYPE = COption::GetOptionString("bitlate.proshop", "NL_PRODUCT_SIZE_TYPE_VALUE", false, SITE_ID);
if ($ACTION_POS == 'product') {
    $PAGE_ELEMENT_COUNT = COption::GetOptionString("bitlate.proshop", "NL_MAIN_TABS_PAGE_ELEMENT_COUNT_BANNERS", false, SITE_ID);
} elseif ($PRODUCT_SIZE_TYPE == 'max') {
    $PAGE_ELEMENT_COUNT = COption::GetOptionString("bitlate.proshop", "NL_MAIN_TABS_PAGE_ELEMENT_COUNT_MAX", false, SITE_ID);
} else {
    $PAGE_ELEMENT_COUNT = COption::GetOptionString("bitlate.proshop", "NL_MAIN_TABS_PAGE_ELEMENT_COUNT", false, SITE_ID);
}
$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "ELEMENT_SORT_FIELD2" => "#NL_MAIN_TABS_ELEMENT_SORT_FIELD2#",
        "ELEMENT_SORT_ORDER2" => "#NL_MAIN_TABS_ELEMENT_SORT_ORDER2#",
        "META_KEYWORDS" => "-",
        "META_DESCRIPTION" => "-",
        "BROWSER_TITLE" => "-",
