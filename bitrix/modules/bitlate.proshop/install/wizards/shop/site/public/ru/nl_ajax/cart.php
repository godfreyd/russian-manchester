            ...
            if (\Bitrix\Main\Loader::includeModule("sale")) {
                ...
                if ($id > 0) {
                    ...
                    if ($arItem && !CSaleBasketHelper::isSetItem($arItem)) {
                        $isFloatQuantity = ((isset($arItem["MEASURE_RATIO"]) && floatval($arItem["MEASURE_RATIO"]) > 0 && $arItem["MEASURE_RATIO"] != 1) || (isset($_POST['useFloatQuantity']) && $_POST['useFloatQuantity'] == "Y")) ? true : false;
                        ...
                        if (CSaleBasket::Update($arItem["ID"], array('QUANTITY' => $quantity))) {
                            ...
                            $arResult['product_total'] = $arResult['item_count'].' '.BitlateProUtils::nl_inclination($arResult['item_count'], GetMessage("NL_PRODUCT_1"), GetMessage("NL_PRODUCT_2"), GetMessage("NL_PRODUCT_10")) . ' ' . GetMessage("NL_ON") . ' ' . $arResult['total'];
                        }
                    }
                }
            } 
