...
$arServices = Array(
    ...
    "iblock" => Array(
        ...
        "STAGES" => Array(
            ...
            "catalog_path1.php",   //импорт товаров
            "catalog_path2.php",   //импорт товаров
            "catalog_path3.php",   //импорт товаров
            "catalog_path4.php",   //импорт товаров
            "catalog_path5.php",   //импорт товаров
            "catalog_path6.php",   //импорт товаров
            "catalog_path7.php",   //импорт товаров
            "catalog_path8.php",   //импорт товаров
            "catalog_path9.php",   //импорт товаров
