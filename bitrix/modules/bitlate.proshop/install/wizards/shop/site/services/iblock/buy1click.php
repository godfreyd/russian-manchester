...
$iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/buy1click.xml";
$iblockCode = "NL_BUY1CLICK_" . WIZARD_SITE_ID;
$iblockType = "services";
$iblockCatalogCode = "NL_GOODS_" . WIZARD_SITE_ID;

CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"] . $iblockXMLFile, array("NL_BUY1CLICK" => $iblockCode));
...
if ($iblockID == false) 
{
	...
	$dbEvent = CEventType::GetList(Array("TYPE_ID" => "NL_BUY1CLICK_" . WIZARD_SITE_ID));
	if(!($dbEvent->Fetch()))
	{
		$et = new CEventType;
		$et->Add(array(
			"LID"         => LANGUAGE_ID,
			"EVENT_NAME"  => 'NL_BUY1CLICK_' . WIZARD_SITE_ID,
			"NAME"        => GetMessage('NL_BUY1CLICK_EVENT_TYPE_NAME'),
			"DESCRIPTION" => GetMessage('NL_BUY1CLICK_EVENT_TYPE_DESCRIPTION'),
		));
        ...
        COption::SetOptionString("bitlate.proshop", "NL_BUY1CLICK_EMAIL", $siteEmail, '', WIZARD_SITE_ID);
        $arFields = array(
            "ACTIVE"     => "Y",
            "EVENT_NAME" => 'NL_BUY1CLICK_' . WIZARD_SITE_ID,
            "LID"        => WIZARD_SITE_ID,
            ...
            "SUBJECT"    => GetMessage('NL_BUY1CLICK_EVENT_SUBJECT'),
            "BODY_TYPE"  => "html",
            "MESSAGE"    => GetMessage('NL_BUY1CLICK_EVENT_MESSAGE'),
        );
