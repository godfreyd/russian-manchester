...
if ($handle) {
    ...
    CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH . "/personal/order/index.php", Array("SITE_DIR" => WIZARD_SITE_DIR));
...
COption::SetOptionString("main", "urlrewrite_exclude_mask", $exc . "*/local/*;");
COption::SetOptionString("subscribe", "subscribe_section", "#SITE_DIR#personal/subscribe/");
COption::SetOptionString("bitlate.proshop", "NL_MODULE_SITE_ID", WIZARD_SITE_ID, false, false);
COption::SetOptionString("bitlate.proshop", "NL_MODULE_SITE_DIR", WIZARD_SITE_DIR, false, false);
?>