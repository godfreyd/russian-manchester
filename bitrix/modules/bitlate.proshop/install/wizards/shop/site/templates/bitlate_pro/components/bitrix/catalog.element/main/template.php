...
$isPriceComposite = ($arParams["REQUEST_LOAD"] == "Y") ? "N" : COption::GetOptionString("bitlate.proshop", "NL_CATALOG_PRICE_COMPOSITE", false, SITE_ID);
if (isset($arResult['OFFERS']) && !empty($arResult['OFFERS'])) {
    $artCode = COption::GetOptionString("bitlate.proshop", 'NL_CATALOG_OFFERS_ART_CODE', false, SITE_ID);
} else {
    $artCode = COption::GetOptionString("bitlate.proshop", 'NL_CATALOG_ART_CODE', false, SITE_ID);
}
    ...
    <div class="product-preview-main relative">
        ...
        <div class="product-preview-main-content video<?if ($arFirstPhoto['TYPE'] == "video"):?> active<?endif;?>">
            <div class="responsive-embed">
                <iframe src="<?=(($arFirstPhoto['TYPE'] == "video") ? $arFirstPhoto['SRC'] : '')?>" frameborder="0" allowfullscreen></iframe>
            </div>
        </div>
    </div>
