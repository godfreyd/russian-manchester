                                ...
                                <div class="inline-block-container">
                                    <div class="inline-block-item vertical-middle small-12 medium-6 large-4">
                                        <div class="product-price">
                                            <div class="product-info-caption"><?=GetMessage("CT_BCS_TPL_FAVORITES_PRICE")?> <?=str_replace(GetMessage("CT_BCS_TPL_MEASURE_SEARCH"), GetMessage("CT_BCS_TPL_MEASURE_REPLACE"), $arItem["CATALOG_MEASURE_NAME"])?></div>
                                            <?if (!empty($minPrice)):?>
                                            <div class="main"><?=CCurrencyLang::CurrencyFormat($minPrice['DISCOUNT_VALUE'] / $arItem['CATALOG_MEASURE_RATIO'], $minPrice['CURRENCY'])?></div>
                                        <?endif;?>
                                        <?if ('Y' == $arParams['SHOW_OLD_PRICE'] && $discount > 0):?>
                                            <div class="old"><?=CCurrencyLang::CurrencyFormat($maxPriceValue / $arItem['CATALOG_MEASURE_RATIO'], $arItem['MIN_PRICE']['CURRENCY'])?></div>
                                        <?endif;?>
                                        </div>
                                    </div>
                                    <div class="inline-block-item vertical-middle small-12 medium-6 large-8 column-for-add2cart" id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>">
                                        ...
                                        <input class="input-group-field" type="hidden" id="<? echo $arItemIDs['QUANTITY']; ?>" name="<? echo $arParams["PRODUCT_QUANTITY_VARIABLE"]; ?>" value="<? echo $arItem['CATALOG_MEASURE_RATIO']; ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
