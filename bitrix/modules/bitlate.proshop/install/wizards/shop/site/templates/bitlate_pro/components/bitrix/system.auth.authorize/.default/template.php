...
?>
<div id="login<?if ($isStatic):?>-static<?endif;?>" class="fancybox-block fancybox-block-login">
    ...
    <?if($arResult["AUTH_SERVICES"]):?>
        <div class="fancybox-block-social">
            <div class="text-center login-social"><?=GetMessage("AUTH_AUTHORIZE_SOCSERV")?></div>
            <?
