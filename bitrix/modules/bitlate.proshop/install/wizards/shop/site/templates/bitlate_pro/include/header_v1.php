    ...
    <div class="advanced-container inline-block-container relative header-mobile-fixed">
        ...
        <a href="<?=SITE_DIR?>" class="header-logo inline-block-item vertical-middle">
            <?$APPLICATION->IncludeFile(
                ...
                Array(
                    "PATH_TO_LOGO" => SITE_TEMPLATE_PATH . "/themes/" . $templateOptions['theme'] . "/images/logo.png",
                )
            );?>
        </a>
...
<div class="header-line-bottom show-for-xlarge header-menu-fixed">
    <div class="advanced-container inline-block-container relative">
        ...
        <div id="header-main-menu-wrap" class="dropdown-pane header-main-menu-dropdow-wrap" data-dropdown data-close-on-click="true" data-v-offset="24">
