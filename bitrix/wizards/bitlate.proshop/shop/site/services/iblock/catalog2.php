...
if (CBXFeatures::IsFeatureEnabled('CatMultiPrice')) {
    ...
    $iblockXMLFileOffers = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/catalog_sku_base.xml";
...
if ($replacePriceXML_ID != '' && $replacePriceNAME != '') {
    CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"] . $iblockXMLFileOffers, array("NL_PRICE_XML_ID" => $replacePriceXML_ID));
    CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"] . $iblockXMLFileOffers, array("NL_PRICE_NAME" => $replacePriceNAME));
}
