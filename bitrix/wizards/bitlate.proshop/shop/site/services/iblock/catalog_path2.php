...
if (CBXFeatures::IsFeatureEnabled('CatMultiPrice')) {
    $iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/catalog_path2.xml";
} else {
    $iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/catalog_base_path2.xml";
