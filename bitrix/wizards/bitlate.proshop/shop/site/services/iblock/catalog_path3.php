...
if (CBXFeatures::IsFeatureEnabled('CatMultiPrice')) {
    $iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/catalog_path3.xml";
} else {
    $iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/catalog_base_path3.xml";
