...
if (CBXFeatures::IsFeatureEnabled('CatMultiPrice')) {
    $iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/catalog_path4.xml";
} else {
    $iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/catalog_base_path4.xml";
