...
if (CBXFeatures::IsFeatureEnabled('CatMultiPrice')) {
    $iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/catalog_path7.xml";
} else {
    $iblockXMLFile = WIZARD_SERVICE_RELATIVE_PATH . "/xml/" . LANGUAGE_ID . "/catalog_base_path7.xml";
