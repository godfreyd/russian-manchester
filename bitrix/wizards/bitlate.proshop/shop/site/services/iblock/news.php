...
$iblockCode = "NL_NEWS_" . WIZARD_SITE_ID;
$iblockType = "news";

CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"] . $iblockXMLFile, array("NL_NEWS" => $iblockCode));
...
COption::SetOptionString("bitlate.proshop", "NL_NEWS_ID", $iblockID, false, WIZARD_SITE_ID);
CWizardUtil::ReplaceMacros($_SERVER['DOCUMENT_ROOT'].'/local/php_interface/'.WIZARD_SITE_ID.'/init.php', array("NL_NEWS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros($_SERVER['DOCUMENT_ROOT'].'/local/templates/'.WIZARD_TEMPLATE_ID.'/include/index_news.php', array("NL_NEWS_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/company/news/index.php", array("NL_NEWS_IBLOCK_ID" => $iblockID));
?>