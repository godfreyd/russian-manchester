...
if($iblockID == false)
{
	...
	if(!($dbEvent->Fetch()))
	{
        ...
        COption::SetOptionString("bitlate.proshop", "NL_SERVICE_ORDER_EMAIL", $siteEmail, '', WIZARD_SITE_ID);
        $arFields = array(
            "ACTIVE"     => "Y",
            "EVENT_NAME" => 'NL_SERVICE_ORDER_' . WIZARD_SITE_ID,
            "LID"        => WIZARD_SITE_ID,
...
COption::SetOptionString("bitlate.proshop", "NL_SERVICE_ORDER_ID", $iblockID, false, WIZARD_SITE_ID);
