...
$iblockCode = "NL_SERVICES_" . WIZARD_SITE_ID;
$iblockType = "references";

CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"] . $iblockXMLFile, array("NL_SERVICES" => $iblockCode));
...
COption::SetOptionString("bitlate.proshop", "NL_SERVICES_ID", $iblockID, false, WIZARD_SITE_ID);
CWizardUtil::ReplaceMacros(WIZARD_SITE_PATH."/company/services/index.php", array("NL_SERVICES_IBLOCK_ID" => $iblockID));
?>