...
$iblockCode = "NL_MAIN_SLIDER_" . WIZARD_SITE_ID;
$iblockType = "services";
$iblockCatalogCode = "NL_GOODS_" . WIZARD_SITE_ID;

CWizardUtil::ReplaceMacros($_SERVER["DOCUMENT_ROOT"] . $iblockXMLFile, array("NL_MAIN_SLIDER" => $iblockCode));
...
COption::SetOptionString("bitlate.proshop", "NL_MAIN_SLIDER_ID", $iblockID, false, WIZARD_SITE_ID);
CWizardUtil::ReplaceMacros($_SERVER['DOCUMENT_ROOT'].'/local/php_interface/'.WIZARD_SITE_ID.'/init.php', array("NL_MAIN_SLIDER_IBLOCK_ID" => $iblockID));
CWizardUtil::ReplaceMacros($_SERVER['DOCUMENT_ROOT'].'/local/templates/'.WIZARD_TEMPLATE_ID.'/include/index_main.php', array("NL_MAIN_SLIDER_IBLOCK_ID" => $iblockID));
?>