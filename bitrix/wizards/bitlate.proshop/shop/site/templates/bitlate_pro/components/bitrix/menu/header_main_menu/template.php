...
if (!empty($arResult)):
    ...
    <?else:?>
        <nav class="header-main-menu header-menu-fixed show-for-xlarge inline-block-item vertical-middle">
            <ul class="header-main-menu-other menu">
                <li class="header-main-menu-category">
                    <a href="javascript:;" data-toggle="header-main-menu-full" class="header-main-menu-button"><?=GetMessage("MENU_ITEM_CATALOG_TITLE")?></a>
                    <div id="header-main-menu-full" class="dropdown-pane header-main-menu-dropdow-full" data-dropdown data-hover="true" data-hover-pane="true" data-v-offset="25">
                        <span class="header-main-menu-dropdown-arrow"><span class="inner"></span></span>
                        <ul class="container inline-block-container">
    <?endif;?>
                ...
                <ul class="header-main-menu-other menu float-right hide">
                    <li class="header-main-menu-category">
                        <a href="#" data-toggle="header-main-menu-full">
                            ...
                            <span><?=GetMessage("MENU_ITEM_OTHER")?></span>
                        </a>
