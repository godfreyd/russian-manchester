	...
	else
	{
		...
		else
		{
            ...
            <div class="bx_ordercart text-center">
                ...
                <div class="cart-caption-desc price-block bx_ordercart_order_sum"><?=$prodCount?> <?=BitlateProUtils::nl_inclination($prodCount, GetMessage('NL_PRODUCT_1'), GetMessage('NL_PRODUCT_2'), GetMessage('NL_PRODUCT_10'))?> <?=GetMessage('NL_ON')?> <?=$arResult["ORDER_TOTAL_PRICE_FORMATED"]?></div>
            </div>
