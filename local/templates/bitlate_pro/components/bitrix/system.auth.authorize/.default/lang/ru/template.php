...
$MESS["AUTH_FIRST_ONE"] = "У Вас нет аккаунта?";
$MESS["AUTH_FORGOT_PASSWORD_2"] = "Забыли?";
$MESS["AUTH_CAPTCHA_PROMT"] = "Код с картинки";
...
$MESS["AUTH_AUTHORIZE_SOCSERV"] = "Или войти через социальную сеть";
?>