...
<ul class="inner-content-list row large-up-2">
    <li class="inner-content-delivery columns table-container">
        <div class="preview table-item vertical-top">
            <img src="/local/templates/bitlate_pro/images/delivery-russianpost.jpg" alt="">
        </div>
    ...
    <li class="inner-content-delivery columns table-container">
        <div class="preview table-item vertical-top">
            <img src="/local/templates/bitlate_pro/images/delivery-ems.jpg" alt="">
        </div>
        <div class="table-item">
    ...
    <li class="inner-content-delivery columns table-container">
        <div class="preview table-item vertical-top">
            <img src="/local/templates/bitlate_pro/images/delivery-spsr.jpg" alt="">
        </div>
        <div class="table-item">
    ...
    <li class="inner-content-delivery columns table-container">
        <div class="preview table-item vertical-top">
            <img src="/local/templates/bitlate_pro/images/delivery-dhl.jpg" alt="">
        </div>
        <div class="table-item">
    ...
    <li class="inner-content-delivery columns table-container">
        <div class="preview table-item vertical-top">
            <img src="/local/templates/bitlate_pro/images/delivery-ups.jpg" alt="">
        </div>
        <div class="table-item">
    ...
    <li class="inner-content-delivery columns table-container">
        <div class="preview table-item vertical-top">
            <img src="/local/templates/bitlate_pro/images/delivery-pony-express.jpg" alt="">
        </div>
        <div class="table-item">
