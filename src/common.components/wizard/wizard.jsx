...
const stepConfig = [
    {
        ...
        title: i18n('wizard-1-title'),
        description: i18n('wizard-1-description'),
        style: { paddingLeft: '62px' }
    },
    {
        videoSrc: '/wizard/step2.mp4',
        title: i18n('wizard-2-title'),
        description: i18n('wizard-2-description'),
        style: { paddingLeft: '24px' }
    },
    {
        videoSrc: '/wizard/step3.mp4',
        title: i18n('wizard-3-title'),
        description: i18n('wizard-3-description'),
        style: { paddingRight: '13px' }
    },
    {
        videoSrc: '/wizard/step4.mp4',
        title: i18n('wizard-4-title'),
        description: i18n('wizard-4-description'),
